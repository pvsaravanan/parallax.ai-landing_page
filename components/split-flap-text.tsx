...
function SplitFlapTextInner({ text, className = "", speed = 50, fontSize = "clamp(4rem, 15vw, 14rem)" }: SplitFlapTextProps) {
...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, fontSize, playClick }: SplitFlapCharProps) {
